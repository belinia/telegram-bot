...
const sohbetKomutlari = {
  ...
  "bot": () => "haha çok mu komiksin sen",
  "sus": () => "susmıycam",
  "şaka": () => "Bilgisayar neden denize girmez? Çünkü suyu sevmez 😅",
  "motivasyon": () => "Başarı, küçük adımların toplamıdır 💪",
  "romantik": () => "Gözlerinin sükûnetinde susmuş sana birikiyorum🌹",
  "fal": () => "Bugün yıldızlar senin için gülümsüyor ✨",
  "zihinoku": () => "Şu an benim gerçekten aklını okuyabileceğimi düşünüyorsun hhhh  🤔",
  "itiraf": () => "Sana bir sır vereyim mi? 🤫",
  "ver": () => "sahibim çok güzell",
  ...
  "b": () => (Math.random() < 0.5 ? "jewel of my heart" : "the rhythm of my heart"),
  "b": () => (Math.random() < 0.5 ? "Beliyna's first love" : "Beliyna's last love"),
